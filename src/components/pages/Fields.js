          ...
          <Col xs={2}>
            ...
            <Sticky enabled={true} top={10}>
              <form className="faceted-search">
                <h5 className="h-five" style={{ textAlign: "center" }}>Filter</h5>
                <hr />
                <h6 className="h-six">Outdoor: <input type="checkbox" name="Outdoor" style={{ float: "right" }} onChange={handleCheckboxChange} checked={selectedEnvironment.includes("Outdoor")} /></h6>
                <h6 className="h-six">Indoor: <input type="checkbox" name="Indoor" style={{ float: "right" }} onChange={handleCheckboxChange} checked={selectedEnvironment.includes("Indoor")} /></h6>
              </form>
            </Sticky>
          </Col>
          <Col>
