        ...
        <div class="row">
            <div class="col">        
                <div class="card-field">
                    ...
                    <div class="card-body-field">
                        ...
                        <p class="card-text-field"> The Richcraft Field is a high quality outdoor turf soccer field located in Kanata. The field is closed off in the Winter</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">        
                <div class="card-field">
                    ...
                    <div class="card-body-field">
                        ...
                        <p class="card-text-field"> The Immaculata High School Soccer Field is a new outdoor turf soccer field located in Central Ottawa. The field is closed off in the Winter</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">        
                <div class="card-field">
                    ...
                    <div class="card-body-field">
                        <h5 class="card-title-field">Ben Franklin dome - Nepean</h5>
                        <p class="card-text-field"> The Ben Franklin dome Soccer Field is an indoor turf field located in Nepean. Summer matches will be played at the field next to the dome.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col">        
                <div class="card-field">
                    ...
                    <div class="card-body-field">
                        <h5 class="card-title-field">Sooners Superdome - Stitsville</h5>
                        <p class="card-text-field">The Sooners Superdome Soccer Field is an amazing new indoor turf field located in Stitsville. This new facility is great for Winter games or for when the weather is not ideal.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">        
                <div class="card-field">
                    ...
                    <div class="card-body-field">
                        <h5 class="card-title-field">Complexe Branchaud-Brière - Gatineau</h5>
